...
Page({
  ...
  data: {
    items: [
      ...
      { name: 'CustomerManager', value: '客户经理' },
      { name: 'GeneralManager', value: '总经理' },
      { name: 'Customer', value: '顾客' },
  ...
  submit:function(e){//提交校验登录
    ...
    else if (that.data.choosed === 'CustomerManager'){
      wx.navigateTo({
        url: '../../pages/manage/manage'
      })
    }
    else if (that.data.choosed === 'GeneralManager'){
      wx.navigateTo({
        url: '../../pages/goodsList/goodsList'
      })
    }
    else if (that.data.choosed ==='Customer'){
      wx.navigateTo({
        url: '../../pages/rec/rec'
      })
    }
